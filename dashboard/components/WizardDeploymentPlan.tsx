...
import { LuCircleCheckBig, LuCalendar, LuDollarSign, LuShield, LuCode, LuRocket, LuFileText, LuUsers, LuTriangleAlert } from 'react-icons/lu';
...
export default function WizardDeploymentPlan({
  ...
  return (
    <div>
      ...
      <Card className="mb-6 bg-blue-50 dark:bg-blue-900/20 border-blue-600">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="flex items-center gap-2">
            <LuDollarSign size={20} className="text-green-600" />
            <div>
          ...
          <div className="flex items-center gap-2">
            <LuShield size={20} className="text-amber-500" />
            <div>
          ...
          <div className="flex items-center gap-2">
            <LuUsers size={20} className="text-red-500" />
            <div>
            ...
            <div key={idx} className={`p-4 rounded-md border-2 ${phase.borderClass} ${phase.bgClass}`}>
              ...
              <div className="flex flex-col gap-1">
                {phase.tasks.map((task, taskIdx) => (
                  <div key={taskIdx} className="flex items-start gap-2">
                    <LuCircleCheckBig size={16} className={`${phase.iconClass} mt-0.5 flex-shrink-0`} />
              ...
              {phase.deliverables.length > 0 && (
                <div className="mt-2 p-2 bg-white dark:bg-zinc-800 rounded-md">
                  <span className="text-xs font-semibold text-zinc-900 dark:text-white">LuKey Deliverables: </span>
      ...
      <Card className="mb-6">
        <div className="flex items-center gap-2 mb-4">
          <LuRocket size={24} className="text-blue-600" />
...
function generatePhases(state: WizardState): Phase[] {
  ...
  phases.push({
    ...
    deliverables: ['Production system', 'LuUser documentation', 'Monitoring dashboards'],
    icon: LuRocket,
    iconClass: 'text-blue-600',
    borderClass: 'border-blue-600',
    bgClass: 'bg-blue-50 dark:bg-blue-900/20'
  ...
  phases.push({
    name: 'LuMonitor & Optimize',
    description: 'Ongoing monitoring, improvement, and maintenance',
    duration: 0,
    tasks: ['LuMonitor performance metrics and KPIs', 'Collect user feedback and iterate', 'Retrain models with new data', 'Optimize costs and performance', 'Maintain compliance documentation'],
