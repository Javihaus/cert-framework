...
import { LuUpload, LuDownload, LuCircleCheckBig, LuFileText, LuCircleAlert, LuInfo } from 'react-icons/lu';
...
const DOCUMENT_TYPES: DocumentType[] = [
  ...
  // Compliance Templates
  {
    ...
    name: 'EU AI Act Compliance LuPackage',
        ...
        {!downloadUrl ? (
          <>
            ...
            <Card className="mb-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className={typographyClasses.sectionTitle}>
                  LuUpload Production Traces
                </h2>
              </div>
              <p className={cn(typographyClasses.body, "mb-4")}>
                LuUpload your JSONL file containing production traces (generated by CERT monitoring)
              </p>
              <FileUpload
                onFileLoad={handleFileLoad}
                accept=".jsonl,.json"
                label="LuUpload Traces LuFile"
              />
            </Card>
                      ...
                      >
                        <div className="flex items-start gap-3">
                          <div className={cn(
                            ...
                            {selectedDocs.includes(doc.id) && (
                              <LuCircleCheckBig size={14} className="text-white" />
                            )}
                          </div>
            ...
            <Card className="bg-amber-50 dark:bg-amber-900/20 border-amber-200 dark:border-amber-800 mb-6">
              <div className="flex items-start gap-3">
                <LuInfo size={20} className="text-amber-600 dark:text-amber-400 flex-shrink-0 mt-0.5" />
                <div>
            ...
            {error && (
              <div className="mb-4 p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg flex items-start gap-3">
                <LuCircleAlert size={20} className="text-red-600 dark:text-red-400 flex-shrink-0 mt-0.5" />
            ...
            <Button
              ...
              icon={isGenerating ? undefined : <LuFileText size={16} />}
              variant="primary"
              size="lg"
              fullWidth
            >
          ...
          <Card className="bg-green-50 dark:bg-green-900/20 border-green-200 dark:border-green-800">
            <div className="text-center py-8">
              <LuCircleCheckBig size={64} className="text-green-600 dark:text-green-400 mx-auto mb-4" />
