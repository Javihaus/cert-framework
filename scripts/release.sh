...
echo "Running tests..."
python3 -c "from cert import measure, monitor, Preset, PRESETS; print('✓ Import successful')"
python3 -c "from cert import measure; result = measure('hello', 'hello'); assert result.matched; print('✓ Basic test passed')"
...
echo "  python3 -c 'from cert import measure, monitor; print(\"✓ TestPyPI install works\")'"
echo "  deactivate"
echo ""
...
echo "  python3 -c 'from cert import measure, monitor; print(\"✓ PyPI install works\")'"
echo "  deactivate"
echo ""
