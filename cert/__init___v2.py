"""CERT Framework v2.0 - Simplified API

Three core functions for AI system testing:
...
This is the NEW v2.0 API. For v1.x compatibility, the old API is still available.
"""
