"""Type definitions for CERT benchmark framework.

This module defines result dataclasses for all benchmark metrics including:
...
class BenchmarkSummary:
    """Complete benchmark execution summary.

    Aggregates all results with metadata about the benchmark run.
    """
