...
class CERTBenchmarkEngine:
    """CERT Framework benchmarking engine with pluggable metrics.

    This engine orchestrates benchmark execution across multiple providers
    ...
    async def run_full_benchmark(
        ...
        self.logger.info("=" * 60)
        self.logger.info("Starting CERT Benchmark Suite")
        self.logger.info("=" * 60)
    ...
    def _build_summary(
        ...
        """Build benchmark summary from all results.
