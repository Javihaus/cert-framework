...
class AuditLogger:
    ...
    def log_request(
        ...
        entry = {
            ...
            "metrics": {
                "semantic_score": round(metrics.get("semantic_score", 0.0), 4),
                "nli_score": round(metrics.get("nli_score", 0.0), 4),
                "grounding_score": round(metrics.get("grounding_score", 0.0), 4),
                "is_contradiction": metrics.get("is_contradiction", False),
                "ungrounded_terms_count": metrics.get("ungrounded_terms_count", 0),
            },
