...
from cert.utilities.rag.embeddings import EmbeddingComparator, ComparisonResult
from cert.utilities.rag.fact_extractor import check_factual_contradiction
...
def compare(
    ...
    if use_nli:
        ...
        if not hasattr(_default_comparator, "_nli_detector"):
            ...
            from cert.utilities.rag.nli import NLIDetector
            from cert.utilities.rag.energy import ProductionEnergyScorer
